...
package dev.nafusoft.soloservercore.event.player;
...
public abstract class PlayerStatusUpdateEvent extends Event {
    private static final HandlerList handlers = new HandlerList();

    private final InGameSSCPlayer player;

    protected PlayerStatusUpdateEvent(Player player) {
        this.player = SoloServerApi.getInstance().getSSCPlayer(player);
    }

    protected PlayerStatusUpdateEvent(InGameSSCPlayer player) {
        this.player = player;
    }
